          ...
          <div class="objects-grid gutters-sm mt-5 offset-md-1">
            <div class="form-row col-md-12" >
              <div class="object-vertical col-xl-6 col-md-12 mb-4 mt-3" >
                ...
                <h3 class="text-primary mt-1 text-justify mr-4">Aqui você pode ficar a vontade para tirar qualquer tipo de dúvida!</h3>
                <h4 class=" text-danger mt-1 mb-3 mr-4">Pode ser por qualquer uma de nossas redes sociais</h4>
                ...
                <h6 class="text-primary text-justify mr-4 mt-3 mb-3">Mas se preferir, pode deixar uma mensagem ao lado que logo entraremos em contato!</h6>
