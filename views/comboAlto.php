...
<hr>
<h5 class="cardtitle6">Planos Digitais 
...
<div class="col mt-2">
    <a class="" data-toggle="modal" data-target="#modal_watch">
        <img src="<?= $uri ?>/node_modules/img/planos/watch-mini.png" loading="lazy" class="btn-planos  h-75">
    </a>

    <a class="" data-toggle="modal" data-target="#modal_noggin">
        <img src="<?= $uri ?>/node_modules/img/planos/noggin-mini.png" loading="lazy" class="btn-planos h-75">
    </a>
    <a class="" data-toggle="modal" data-target="#modal_paramount">
        <img src="<?= $uri ?>/node_modules/img/planos/paramount-mini.png" loading="lazy"  class="btn-planos  h-75">
    </a>
